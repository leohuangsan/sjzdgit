...
{
    public partial class MessageBoxOKCancel : NewStyleFrm
    {
        //消息标题
        ...
        public MessageBoxOKCancel(string MesgContent, string MesgTitle, MessageBoxNewIco messageBoxNewIco)
        {
            InitializeComponent();
        ...
        private void MessageBoxOKCancel_Load(object sender, EventArgs e)
        {
